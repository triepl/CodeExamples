...
<div class="raitings index large-9 medium-8 columns content">
    <h3><?= __('Raitings') ?></h3>
    <table cellpadding="0" cellspacing="0">
        <thead>
            <tr>
                ...
                <th scope="col"><?= $this->Paginator->sort('raiting') ?></th>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="actions">
                    <?= $this->Html->link(__('View'), ['action' => 'view', $raiting->id]) ?>
                    <?= $this->Html->link(__('Edit'), ['action' => 'edit', $raiting->id]) ?>
                    <?= $this->Form->postLink(__('Delete'), ['action' => 'delete', $raiting->id], ['confirm' => __('Are you sure you want to delete # {0}?', $raiting->id)]) ?>
                </td>
            </tr>
            <?php endforeach; ?>
        </tbody>
